...
class Query{
  ...
  async save(document) {
    ...
    return this.db.oneOrNone(sql, [this.tableName, document], r => r && r.res);
  }
  ...
  async modify(id, mod){
    ...
    return this.db.oneOrNone(sql, [this.tableName, id, mod], r => r && r.res);
  }
  ...
  async get(id) {
    ...
    return this.db.one(sql, [this.tableName, parseInt(id)], r => r.res);
  }
  ...
  async find_one(criteria) {
    ...
    // TODO: "result" can bomb on null below, if oneOrNone is correct choice
